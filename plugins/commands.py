...
𝖥𝗂𝗅𝖾𝗌 𝖲𝖾𝗇𝖽 𝖶𝗂𝗅𝗅 𝖡𝖾 𝖣𝖾𝗅𝖾𝗍𝖾𝖽 𝖠𝖿𝗍𝖾𝗋 1 𝖬𝗂𝗇𝗎𝗍𝖾𝗌 𝖳𝗈 𝖠𝗏𝗈𝗂𝖽 𝖢𝗈𝗉𝗒𝗋𝗂𝗀𝗁𝗍. 𝖲𝗈 𝖲𝖺𝗏𝖾 𝖳𝗁𝖾 𝖥𝗂𝗅𝖾 𝖳𝗈 𝖲𝖺𝗏𝖾𝖽 𝖬𝖾𝗌𝗌𝖺𝗀𝖾𝗌
...
async def forward_files(chat_id, skip_count, channel_id, bot, message):
    ...
    for i, file in enumerate(all_files, 1):
        ...
        await bot.send_cached_media(
            ...
            file_id=file["_id"],
            caption=f'📂 Fɪʟᴇ ɴᴀᴍᴇ : <code>{filename}</code>\n╭─────── • ◆ • ───────╮\n» ɢʀᴏᴜᴘ  :  <a href="https://t.me/+V4B2j2y_UGViYWVl">ᴍᴏᴠɪᴇ ʙᴀᴢᴀʀ ᴏꜰꜰɪᴄɪᴀʟ</a>  «\n» ᴜᴘᴅᴀᴛᴇꜱ :  <a href="https://t.me/+WlRlRi4MNF1mOGQ9">ᴍᴏᴠɪᴇ ʙᴀᴢᴀʀ ᴏꜰꜰɪᴄɪᴀʟ</a>«\n╰─────── • ◆ • ───────╯'
        )
        total_files += 1                
